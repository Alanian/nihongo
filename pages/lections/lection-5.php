...
<p>
    Here's a suggestion (which will be used throughout the lections):<br>
    All verbs <strong>end</strong> with a mora from the <strong>u-column</strong>.<br>
    Percisely: <em>u</em>, <em>ku</em>, <em>gu</em>, <em>su</em>, <em>tsu</em>, <em>nu</em>, <em>mu</em>,
    <em>bu</em>, and <em>ru</em>.
</p>
<p>
    ...
    (see <a href="lections.php?lection=3">Lection 3</a>). Other reasons will follow shortly.
</p>
